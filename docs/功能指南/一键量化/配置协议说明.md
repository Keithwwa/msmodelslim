...
| layer_wise | [逐层量化](逐层量化特性说明) | 大模型（≥7B） | 内存占用低，可能需要适配 |
| dp_layer_wise | [分布式逐层量化](分布式逐层量化特性说明) | 大模型（≥7B）多卡场景 | 多设备并行，显著提升量化效率 |
...
| 处理器               | 配置示例       | 配置字段详解       |
| ------------------ | ------------- | ------------- |
| linear_quant       | [linear_quant 配置示例](线性层量化处理器.md/#yaml配置示例) | [linear_quant 配置字段详解](线性层量化处理器.md/#yaml配置字段详解)
| group       | [group 配置示例](分组处理器.md/#yaml配置示例) | [group 配置字段详解](分组处理器.md/#yaml配置字段详解)
...
| Flex AWQ SSZ | [Flex AWQ SSZ 配置示例](../../算法说明/Flex_AWQ_SSZ.md#yaml配置示例) | [Flex AWQ SSZ 配置字段详解](../../算法说明/Flex_AWQ_SSZ.md#yaml配置字段详解)
...
此配置字段与 modelslim_v1 保持一致，参考[modelslim_v1 量化服务配置详解/详细配置字段说明/process - 处理器配置字段](./配置协议说明.md#process---处理器配置字段)
...
此配置字段与 modelslim_v1 保持一致，参考[modelslim_v1 量化服务配置详解/详细配置字段说明/save - 保存器配置字段](./配置协议说明.md#save---保存器配置字段)
