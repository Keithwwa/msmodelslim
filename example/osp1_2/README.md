...
## 使用前准备
请参考 [多模态视图生成推理优化工具](../../docs/zh/feature_guide/scripts_based_quantization_and_other_features/pytorch/inference_optimization_for_multimodal_generative_model.md#使用前准备) 完成环境配置。
