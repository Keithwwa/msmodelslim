...
class TestQwen15ModelAdapterGetModelType(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_model_type方法"""
    ...
    def test_get_model_type_with_valid_type_when_called_then_return_model_type(self):
        ...
        with patch('msmodelslim.model.qwen1_5.model_adapter.DefaultModelAdapter.__init__', return_value=None):
            adapter = Qwen15ModelAdapter(model_type=self.model_type, model_path=self.model_path)
...
class TestQwen15ModelAdapterGetModelPedigree(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_model_pedigree方法"""

    def setUp(self):
        self.model_type = 'Qwen1.5-7B-Chat'
        self.model_path = Path('.')

    def test_get_model_pedigree_when_called_then_return_qwen1_5(self):
        """正常：应返回qwen1_5谱系标识"""
        with patch('msmodelslim.model.qwen1_5.model_adapter.DefaultModelAdapter.__init__', return_value=None):
            adapter = Qwen15ModelAdapter(model_type=self.model_type, model_path=self.model_path)
            ...
            self.assertEqual(result, 'qwen1_5')


class TestQwen15ModelAdapterLoadModel(unittest.TestCase):
    """测试Qwen15ModelAdapter的load_model方法"""
...
class TestQwen15ModelAdapterHandleDataset(unittest.TestCase):
    """测试Qwen15ModelAdapter的handle_dataset方法"""
...
class TestQwen15ModelAdapterHandleDatasetByBatch(unittest.TestCase):
    """测试Qwen15ModelAdapter的handle_dataset_by_batch方法"""
...
class TestQwen15ModelAdapterInitModel(unittest.TestCase):
    """测试Qwen15ModelAdapter的init_model方法"""
...
class TestQwen15ModelAdapterGenerateModelVisit(unittest.TestCase):
    """测试Qwen15ModelAdapter的generate_model_visit方法"""
    ...
    def test_generate_model_visit_with_valid_model_when_called_then_yield_from_visit_func(self):
        ...
        with patch('msmodelslim.model.qwen1_5.model_adapter.DefaultModelAdapter.__init__', return_value=None):
            ...
            with patch('msmodelslim.model.qwen1_5.model_adapter.generated_decoder_layer_visit_func') as mock_visit_func:
...
class TestQwen15ModelAdapterGenerateModelForward(unittest.TestCase):
    """测试Qwen15ModelAdapter的generate_model_forward方法"""
    ...
    def test_generate_model_forward_with_valid_inputs_when_called_then_yield_from_forward_func(self):
        ...
        with patch('msmodelslim.model.qwen1_5.model_adapter.DefaultModelAdapter.__init__', return_value=None):
            ...
            with patch(
                'msmodelslim.model.qwen1_5.model_adapter.transformers_generated_forward_func'
...
class TestQwen15ModelAdapterEnableKvCache(unittest.TestCase):
    """测试Qwen15ModelAdapter的enable_kv_cache方法"""
...
class TestQwen15ModelAdapterGetKvcacheSmoothFusedSubgraph(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_kvcache_smooth_fused_subgraph方法"""
...
class TestQwen15ModelAdapterGetHeadDim(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_head_dim方法"""
...
class TestQwen15ModelAdapterGetNumKeyValueGroups(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_num_key_value_groups方法"""
...
class TestQwen15ModelAdapterGetNumKeyValueHeads(unittest.TestCase):
    """测试Qwen15ModelAdapter的get_num_key_value_heads方法"""
...
class TestQwen15ModelAdapterLoadTokenizer(unittest.TestCase):
    """测试Qwen15ModelAdapter的_load_tokenizer方法"""
    ...
    def test_load_tokenizer_with_trust_remote_code_true_when_called_then_use_safe_generator(self):
        ...
        with patch('msmodelslim.model.qwen1_5.model_adapter.DefaultModelAdapter.__init__', return_value=None):
            ...
            with patch(
                'msmodelslim.model.qwen1_5.model_adapter.SafeGenerator.get_tokenizer_from_pretrained'
